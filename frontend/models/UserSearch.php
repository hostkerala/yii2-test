...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'confirmed_at', 'blocked_at', 'flags', 'role', 'address', 'city_id', 'created_at', 'updated_at', 'state_id'], 'integer'],
            [['password_hash', 'auth_key', 'unconfirmed_email', 'registration_ip', 'first_name', 'last_name', 'email', 'username', 'password', 'phone', 'secret_key', 'avatar'], 'safe'],
        ];
    }
